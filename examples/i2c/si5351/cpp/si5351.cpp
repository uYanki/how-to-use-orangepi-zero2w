...
*/
/**************************************************************************/
err_t SI5351::begin(const char* device)
{
    /* Initialise I2C */
    if (device == nullptr)
    {
    ...
    fd = wiringPiI2CSetupInterface(device, SI5351_ADDRESS);
...
*/
/**************************************************************************/
err_t SI5351::setClockBuilderData(void)
{
    uint16_t i = 0;
...
*/
/**************************************************************************/
err_t SI5351::setupPLLInt(si5351PLL_t pll, uint8_t mult)
{
...
*/
/**************************************************************************/
err_t SI5351::setupPLL(si5351PLL_t pll, uint8_t mult, uint32_t num, uint32_t denom)
{
...
*/
/**************************************************************************/
err_t SI5351::setupMultisynthInt(uint8_t output, si5351PLL_t pllSource, si5351MultisynthDiv_t div)
{
    return setupMultisynth(output, pllSource, div, 0, 1);
}

err_t SI5351::setupRdiv(uint8_t output, si5351RDiv_t div)
{
...
*/
/**************************************************************************/
err_t SI5351::setupMultisynth(uint8_t output, si5351PLL_t pllSource, uint32_t div, uint32_t num, uint32_t denom)
{
    ...
    ASSERT_STATUS(write8(baseaddr + 0, (P3 & 0xFF00) >> 8));
    ASSERT_STATUS(write8(baseaddr + 1, P3 & 0xFF));
    ASSERT_STATUS(write8(baseaddr + 2, ((P1 & 0x30000) >> 16) | lastRdivValue[output]));
    ASSERT_STATUS(write8(baseaddr + 3, (P1 & 0xFF00) >> 8));
    ASSERT_STATUS(write8(baseaddr + 4, P1 & 0xFF));
    ASSERT_STATUS(write8(baseaddr + 5, ((P3 & 0xF0000) >> 12) | ((P2 & 0xF0000) >> 16)));
    ASSERT_STATUS(write8(baseaddr + 6, (P2 & 0xFF00) >> 8));
    ASSERT_STATUS(write8(baseaddr + 7, P2 & 0xFF));
...
*/
/**************************************************************************/
err_t SI5351::enableOutputs(bool enabled)
{
    /* Make sure we've called init first */
    ASSERT(m_si5351Config.initialised, ERROR_DEVICENOTINITIALISED);
...
*/
/**************************************************************************/
err_t SI5351::enableSpreadSpectrum(bool enabled)
{
    uint8_t regval;
...
*/
/**************************************************************************/
err_t SI5351::write8(uint8_t reg, uint8_t value)
{
...
*/
/**************************************************************************/
err_t SI5351::read8(uint8_t reg, uint8_t* value)
{
