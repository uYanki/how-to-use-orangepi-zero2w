...
#define REG_INTENABLE1           0x02
#define REG_INTENABLE2           0x03
...
#define REG_PARTICLECONFIG       0x0A
#define REG_LED1_PULSEAMP        0x0C
#define REG_LED2_PULSEAMP        0x0D
#define REG_LED_PROX_AMP         0x10
#define REG_MULTILEDCONFIG1      0x11
#define REG_MULTILEDCONFIG2      0x12

// Die Temperature Registers
#define REG_DIETEMPINT           0x1F
#define REG_DIETEMPFRAC          0x20
#define REG_DIETEMPCONFIG        0x21

// Proximity Function Registers
#define REG_PROXINTTHRESH        0x30

// IDs
#define REG_REVISIONID           0xFE
#define REG_PARTID               0xFF
#define MAX30102_EXPECTEDPARTID  0x15

// Interrupt Configuration
#define MASK_INT_A_FULL          (uint8_t) ~0b10000000
#define INT_A_FULL_ENABLE        0x80
#define INT_A_FULL_DISABLE       0x00

#define MASK_INT_DATA_RDY        (uint8_t) ~0b01000000
#define INT_DATA_RDY_ENABLE      0x40
#define INT_DATA_RDY_DISABLE     0x00

#define MASK_INT_ALC_OVF         (uint8_t) ~0b00100000
#define INT_ALC_OVF_ENABLE       0x20
#define INT_ALC_OVF_DISABLE      0x00

#define MASK_INT_PROX_INT        (uint8_t) ~0b00010000
#define INT_PROX_INT_ENABLE      0x10
#define INT_PROX_INT_DISABLE     0x00

#define MASK_INT_DIE_TEMP_RDY    (uint8_t) ~0b00000010
#define INT_DIE_TEMP_RDY_ENABLE  0x02
#define INT_DIE_TEMP_RDY_DISABLE 0x00

#define MASK_SAMPLEAVG           (uint8_t) ~0b11100000
...
#define MASK_ROLLOVER            0xEF
#define ROLLOVER_ENABLE          0x10
#define ROLLOVER_DISABLE         0x00

#define MASK_A_FULL              0xF0

// Mode configuration commands
#define MASK_SHUTDOWN            0x7f
#define SHUTDOWN                 0x80
#define WAKEUP                   0x00
#define MASK_RESET               0xBF
#define RESET                    0X40
/// IR led mode
#define MASK_LEDMODE             0xF8
#define LEDMODE_REDONLY          0x02
#define LEDMODE_REDIRONLY        0x03
#define LEDMODE_MULTILED         0x07

// Particle sensing configuration commands
#define MASK_ADCRANGE            0x9F
#define ADCRANGE_2048            0x00
#define ADCRANGE_4096            0x20
#define ADCRANGE_8192            0x40
#define ADCRANGE_16384           0x60

#define MASK_SAMPLERATE          0xE3
...
#define MASK_SLOT1               0xF8
#define MASK_SLOT2               0x8F
#define MASK_SLOT3               0xF8
#define MASK_SLOT4               0x8F
