...
GPIO pv(GPIO06);   // suit le powerActiveFlag
GPIO cri(GPIO13);  // active low
GPIO war(GPIO19);  // active low
GPIO tc(GPIO26);   // Suit le timingControlAlertFlag
...
int main()
{
    ...
    cout << "init         :" << hex << ina3221.init(ADDR_40) << endl;
    ...
    cout << "config       :" << ina3221.setConfiguration(Channel1On, Channel2On, Channel3On, Avg_4, VBUS_4156US, SBUS_332US, ShuntAndBusVoltageContinuous) << endl;
    ...
    cout << "Mask         :" << ina3221.setMaskEnable(SummationChannelControl1On, SummationChannelControl2On, SummationChannelControl3On, WarningAlertLatchEnableOff, CriticalAlertLatchEnableOff) << dec << endl;
