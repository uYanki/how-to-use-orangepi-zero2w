...
// *******************************
bool INA219::init(Address address)
{
    I2C::init(address);
...
// @Return true si ok, false sinon
// *******************************
bool INA219::config(BusVoltageRange busVoltageRange, Gain gain, BusADCResolution busADCResolution, ShuntADCResolution shuntADCResolution, Mode mode)
{
    return !write_word_swapped(Config, busVoltageRange | gain | busADCResolution | shuntADCResolution | mode);
}
...
// @Return true si ok, false sinon
// *******************************
bool INA219::setCalibration_3_2A(BusVoltageRange tensionMax, BusADCResolution busADCResolution, ShuntADCResolution shuntADCResolution, Mode mode)
{
    ...
    bool result1 = !write_word_swapped(Calibration, 4096);
...
// @Return true si ok, false sinon
// *******************************
bool INA219::setCalibration_1_6A(BusVoltageRange tensionMax, BusADCResolution busADCResolution, ShuntADCResolution shuntADCResolution, Mode mode)
{
    ...
    // Set Calibration register to 'calibration' calculated above
    bool result1 = !write_word_swapped(Calibration, 8192);
...
// @Return true si ok, false sinon
// *******************************
bool INA219::setCalibration_0_8A(BusVoltageRange tensionMax, BusADCResolution busADCResolution, ShuntADCResolution shuntADCResolution, Mode mode)
{
    ...
    // Set Calibration register to 'calibration' calculated above
    bool result1 = !write_word_swapped(Calibration, 20480);
...
// @Return true si ok, false sinon
// *******************************
bool INA219::setCalibration_0_4A(BusVoltageRange tensionMax, BusADCResolution busADCResolution, ShuntADCResolution shuntADCResolution, Mode mode)
{
    ...
    // Set Calibration register to 'calibration' calculated above
    bool result1      = !write_word_swapped(Calibration, 40960);
...
float INA219::getBusVoltage_V(void)
{
    ...
    return ((read_word_swapped(BusVoltage) >> 3) * 4) * 0.001;
}
...
{
    return read_word_swapped(ShuntVoltage) * 0.01;
}
...
{
    return read_word_swapped(Current) / currentDivider_mA;
}
...
{
    return read_word_swapped(Power) / powerDivider_mW / 1000.0;
}
...
// **************************************************************
bool INA219::isConversionOk(void)
{
    return read_word_swapped(BusVoltage) & Conversion;
}
...
// True si oui, false sinon
// *******************************************************************************
bool INA219::isOverflow(void)
{
    return read_word_swapped(BusVoltage) & Overflow;
}
